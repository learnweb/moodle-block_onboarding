...
1. Clone this repository: ``git clone https://github.com/wwu-ps-digital-onboarding/moodle-block_steps.git``
2. Navigate to the root directory of the repository: ``cd moodle-block_steps``
3. ``docker-compose up -d``
4. ``docker exec moodle-block_steps_website php var/www/html/moodle/admin/cli/install_database.php --agree-license --adminpass=pw``
...
8. Click on *Customize this page* -> *Add a block* -> *Steps block*
...
3. Choose or create an [issue](https://github.com/wwu-ps-digital-onboarding/moodle-block_steps/issues)
