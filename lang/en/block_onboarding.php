...
$string['attached_links'] = 'Attached Links';
$string['link_url'] = 'URL';
...
$string['new_step'] = 'Add a Step';
$string['edit_step'] = 'Edit Step';
$string['edit_steps'] = 'Edit Steps';
...
$string['newexperience'] = 'Add Your Experience';
...
$string['experience_degreeprogram'] = 'Degree Program';
...
$string['other'] = 'Other';
$string['reason_report'] = 'Choose a reason for reporting this experience';
$string['report_experience'] = 'Report Experience';
$string['report_overview'] = 'Manage Reported Experiences';
$string['experience_description_missing'] = 'Please enter a description.';
$string['filter_or_courses'] = 'Course Filter';
$string['filter_or_categories'] = 'Categories Filter';
$string['filter_or_courses_help'] =
    'This filter is OR connected meaning results from all selected degree programms will be displayed.';
$string['filter_or_categories_help'] =
    'This filter is OR connected meaning also results which only have one of your selected categories are displayed.';
...
$string['selectdegree'] = 'Select Degree Program';
$string['selectcat'] = 'Select Categories';
$string['newdegreeprogram'] = 'Add a Degree Program';
$string['error_notenoughdata'] = 'Before you create an Experience Report the responsible person has to create categories and degree programs. If this problem remains contact the Support.';
...
$string['blocked_overview'] = 'Manage Blocked Users';
...
$string['editexperience'] = 'Edit your Experience';
$string['searchexperiences'] = 'Search Experiences';
...
$string['msg_delete_exp_course_lost'] = '. The course data entries will be lost permanently. Are you sure you want to delete this course?';
